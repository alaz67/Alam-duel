...
mkMob("TAUNT",      0.72, 0.42, function()
    local hum = getHum(); if hum then hum:UnequipTools() end
end)
mkMob("SPINBOT",    0.84, 0.42, function()
...
local mobToggleRow = Instance.new("Frame", setPanel)
mobToggleRow.Size = UDim2.new(1,0,0,50)
mobToggleRow.BackgroundColor3 = CARD
mobToggleRow.BackgroundTransparency = 0.25
mobToggleRow.BorderSizePixel = 0
mobToggleRow.ZIndex = 13
mobToggleRow.LayoutOrder = setOrder + 10
Instance.new("UICorner", mobToggleRow).CornerRadius = UDim.new(0,8)

local mobLbl = Instance.new("TextLabel", mobToggleRow)
mobLbl.Size = UDim2.new(0.6,0,1,0); mobLbl.Position = UDim2.new(0,12,0,0)
mobLbl.BackgroundTransparency = 1; mobLbl.Text = "Show Mobile Buttons"
mobLbl.TextColor3 = WHT; mobLbl.Font = Enum.Font.GothamBold; mobLbl.TextSize = 13
mobLbl.TextXAlignment = Enum.TextXAlignment.Left; mobLbl.ZIndex = 14

local mobBtn = Instance.new("TextButton", mobToggleRow)
mobBtn.Size = UDim2.new(0,78,0,32); mobBtn.Position = UDim2.new(1,-86,0.5,-16)
mobBtn.BackgroundColor3 = Color3.fromRGB(35,45,70); mobBtn.BorderSizePixel = 0
mobBtn.Text = "OFF"; mobBtn.TextColor3 = GRY
...
mobBtn.MouseButton1Click:Connect(function()
    mobVisible = not mobVisible
    mobFrame.Visible = mobVisible
    mobBtn.Text = mobVisible and "ON" or "OFF"
    tw(mobBtn, {BackgroundColor3 = mobVisible and BLUE or Color3.fromRGB(35,45,70)})
    mobBtn.TextColor3 = mobVisible and Color3.fromRGB(5,10,20) or GRY
end)
